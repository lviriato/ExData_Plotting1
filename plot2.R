## Explore and Analyze Data - Project 1 - Plot 2
#
#
...
# Create and copy line plot of two day period for Global active power to png file 
# of size 480x480 pixels

with(epdat, plot(Timestamp, Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)"))
